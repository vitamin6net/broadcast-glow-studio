...
const segColors = [
  "hsl(330,90%,50%)", "hsl(190,100%,40%)", "hsl(45,100%,45%)", "hsl(280,80%,50%)",
  "hsl(150,90%,35%)", "hsl(25,100%,50%)", "hsl(330,90%,50%)", "hsl(190,100%,40%)",
];
...
const RandomPicker = () => {
  ...
  return (
    <div className="overlay-panel glow-magenta max-w-sm mx-auto flex flex-col items-center">
      <h3 className="text-lg font-bold text-neon-magenta tracking-wide mb-5">
        뽑기판
      </h3>
      <div className="relative animate-float" style={{ width: size, height: size }}>
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="w-16 h-16 rounded-full bg-background border-2 border-neon-magenta flex items-center justify-center shadow-lg animate-pulse-glow">
      ...
      <div className="mt-4 px-4 py-1.5 rounded-full bg-neon-yellow/10 border border-neon-yellow/30 text-neon-yellow text-xs font-bold animate-pulse-glow">
        당첨: 노래 한곡!
      </div>
    </div>
  );
