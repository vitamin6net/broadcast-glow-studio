const Scoreboard = () => {
  return (
    <div className="overlay-panel max-w-md mx-auto">
          ...
          {[1, 2, 3, 4, 5].map((r) => (
            <div
              ...
              className={`w-6 h-6 rounded flex items-center justify-center text-[10px] font-display font-bold transition-all ${
                r <= 3 ? "bg-primary/15 text-primary" : r === 4 ? "bg-neon-yellow/15 text-neon-yellow border border-neon-yellow/30 animate-pulse-glow" : "bg-muted text-muted-foreground"
              }`}
            >
              {r}
            </div>
      ...
      <div className="flex items-center gap-4">
        <div className="flex-1 text-center">
          ...
          <div className="text-6xl font-display font-black text-primary leading-none animate-count-pulse">
            7
          </div>
        </div>

        <div className="flex flex-col items-center gap-1">
          <div className="w-11 h-11 rounded-full border-2 border-neon-magenta/40 flex items-center justify-center animate-pulse-glow">
        ...
        <div className="flex-1 text-center">
          ...
          <div className="text-6xl font-display font-black text-neon-magenta leading-none animate-count-pulse" style={{ animationDelay: '1s' }}>
            5
          </div>
        </div>
      </div>
